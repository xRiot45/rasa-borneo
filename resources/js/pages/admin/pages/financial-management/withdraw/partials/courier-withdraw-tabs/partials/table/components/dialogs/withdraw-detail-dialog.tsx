        ...
        <Dialog>
            ...
            <DialogContent className="sm:max-w-3xl">
                ...
                <div className="mt-4 space-y-6 text-sm">
                    ...
                    {/* Informasi Kurir */}
                    <div className="space-y-2">
                        <Label className="text-base font-bold">Informasi Kurir</Label>
                        <div className="mt-2 grid grid-cols-2 gap-2">
                            <span className="text-muted-foreground font-medium">Nama Kurir</span>
                            <span>: {withdraw?.courier?.user?.full_name}</span>

                            <span className="text-muted-foreground font-medium">Nomor Telepon Kurir</span>
                            <span>: {withdraw?.courier?.user?.phone_number}</span>

                            <span className="text-muted-foreground font-medium">Email Kurir</span>
                            <span>: {withdraw?.courier?.user?.email}</span>
                        </div>
                    </div>
