...
export default function MyDeliveriesPage({ myDeliveries }: Props) {
    return (
        <>
            <Head title="Pengantaran Saya" />
            <CourierLayout>
                <main className="mt-22">
                    <div className="flex items-center justify-between">
                        <div>
                            <h2 className="text-lg font-bold">Pengantaran Saya</h2>
                            <p className="text-muted-foreground text-sm"> Lihat dan kelola pesanan yang sedang kamu antar ke pelanggan.</p>
                        </div>
                                    ...
                                    <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="flex flex-col items-start space-y-1">
                                                ...
                                                <p className="text-muted-foreground text-sm">{delivery?.transaction?.merchant?.business_address}</p>
                                                <Badge className="mt-1 rounded-sm">{delivery?.transaction?.transaction_items?.length} Pesanan</Badge>
                                            </div>
                                        </div>
