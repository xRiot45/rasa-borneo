                        ...
                        <div className="flex min-h-screen flex-col bg-white dark:bg-[#171717]">
                            <div className="flex grow items-center px-6 xl:px-10">
                                <div className="mx-auto text-center">
                                    ...
                                    <h1 className="text-gray-1000 text-[22px] leading-normal font-bold text-gray-700 lg:text-2xl dark:text-gray-100">
                                        Jam Operasional Toko Belum Diatur
                                    </h1>
                                    <p className="text-sm leading-loose text-gray-500 lg:text-base lg:leading-loose dark:text-gray-400">
                                        Silahkan perbarui jam operasional toko anda, agar pelanggan dapat mengetahui jam operasional toko.
                                    </p>
                                </div>
                            </div>
                        </div>
