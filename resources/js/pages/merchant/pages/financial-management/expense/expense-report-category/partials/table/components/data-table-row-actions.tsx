...
export function DataTableRowActions({ row }: { row: Row<ExpenseReportCategory> }) {
    const handleDelete = (id: number) => {
        router.delete(route('merchant.expense-report-category.destroy', { id }), {
            onSuccess: () => {
                toast.success('Success', {
                    description: 'Kategori Laporan Pengeluaran Berhasil Dihapus!',
                    action: {
                        label: 'Tutup',
        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-[160px]">
                    <Link href={route('merchant.expense-report-category.edit', { id: row.original.id })}>
