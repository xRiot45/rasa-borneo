...
class MenuItemRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'short_description.string' => 'Deskripsi singkat menu harus berupa teks.',
            'short_description.max' => 'Deskripsi singkat menu tidak boleh lebih dari 255 karakter.',
            ...
            'is_recommended.required' => 'Rekomendasi menu harus dipilih.',
            'is_recommended.boolean' => 'Format rekomendasi menu tidak valid.',
        ];
    }
}
